...
namespace Optispeech.Data.Sources {
    ...
    public class WaveFrontDataSource : DataSourceReader {
        ...
        /// <summary>
        /// The <see cref="WaveFrontDataSource"/> instance on the first <see cref="DataSourceDescription"/> with a <see cref="WaveFrontDataSource"/>
        /// on it's <see cref="DataSourceDescription.readerPrefab"/>
        /// </summary>
        private static WaveFrontDataSource mainDataSource;
        ...
        private static void LoadAdvancedSettings() {
            ...
            mainDataSource = Resources.LoadAll("Data Source Descriptions", typeof(DataSourceDescription)).Cast<DataSourceDescription>()
                .Where(d => d.readerPrefab.TryGetComponent(out WaveFrontDataSource source))
                .FirstOrDefault()
                .readerPrefab.GetComponent<WaveFrontDataSource>();
